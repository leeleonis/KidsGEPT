...
namespace KidsGEPT
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/backend/content/smartadmin").IncludeDirectory("~/areas/backend/content/css", "*.min.css"));
            ...
            bundles.Add(new ScriptBundle("~/scripts/smartadmin").Include(
                ...
                "~/scripts/plugin/bootstrap-combobox/bootstrap-combobox.js",
